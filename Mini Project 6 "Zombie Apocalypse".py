    ...
    def move_humans(self, zombie_distance_field):
        ...
        for (num, human) in enumerate(self._human_list):
            ...
            for neighbor in self.eight_neighbors(human[0], human[1]):
                if zombie_distance_field[neighbor[0]][neighbor[1]] > max_distance and self.is_empty(neighbor[0], neighbor[1]):
    ...
    def move_zombies(self, human_distance_field):
        ...
        for (num, zombie) in enumerate(self._zombie_list):
            ...
            for neighbor in self.four_neighbors(zombie[0], zombie[1]):
                if human_distance_field[neighbor[0]][neighbor[1]] < min_distance and self.is_empty(neighbor[0], neighbor[1]):
